...
1) Don't rely on summaries, Benjamin's arguments have subtleties AI will miss

2) Take notes on the main argument of each section.

3) underline underline underline

4) If screen reading, watch out for F-pattern reading. Instead focus on keywords and arguments.

5) Set rituals and build habits

6) Use Pomodoro Technique (20 minutes focus 5 minute break)